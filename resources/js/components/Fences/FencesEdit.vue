            ...
            <div class="px-4 py-6 sm:p-8">
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <input @input="(val) => (fence.name = fence.name.toUpperCase())" required v-model="fence.name"
...
const { errors, updateFence, fence, getFence } = useFences();

const saveCustomer = async () => {
    updateFence(props.id)
}
