    ...
    <div class="">
        <form @submit.prevent="saveFee()"
            ...
            <div class="px-4 py-6 sm:p-8">
                <h2 class="my-8 text-3xl font-extrabold dark:text-white">Nueva Tarifa</h2>
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">

                    <div class="sm:col-span-6">
                        <label for="first-name" class="block text font-medium leading-6 text-gray-900">CONCEPTO</label>
                        <div class="mt-2">
                            <input @input="(val) => (form.concept = form.concept.toUpperCase())" required v-model="form.concept"
