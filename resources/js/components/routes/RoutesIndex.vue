<template>
    <div>
        <h1 class="my-8 text-5xl font-extrabold dark:text-white">Rutas</h1>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-gray-200 dark:bg-gray-700">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <router-link :to="{ name: 'routes.create' }"
                    ...
                    <template v-for="route in routes" :key="route.id">
                        ...
                        <tr class="font-extrabold">
                            ...
                            <td
                                ...
                                <router-link :to="{ name: 'routes.edit', params: { id: route.id } }"
...
export default {
    setup() {
        const { routes, getRoutes, destroyRoute } = useRoutes();
