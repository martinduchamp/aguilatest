<template>
    <div>
        <h1 class="my-8 text-5xl font-extrabold dark:text-white">Propietarios</h1>
                ...
                <tbody>
                    <template v-for="owner in owners" :key="owner.id">
                        ...
                        <tr class="font-extrabold">
                            ...
                            <td
                                class="border border-slate-300 dark:border-slate-700 p-4 text-black-500 dark:text-slate-400">
                                <template v-for="trailer in owner.trailers">
                                    <span class="text-black mx-1 px-4 py-2 rounded-lg bg-gray-300">{{ trailer.name }}</span>
                                </template>
                            </td>
                            <td
