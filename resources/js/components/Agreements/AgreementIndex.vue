    ...
    <div>
        <div class="md:flex md:items-center md:justify-between my-5 ">
            <div class="min-w-0 flex-1">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-gray-200 sm:truncate sm:text-3xl sm:tracking-tight">Convenios</h2>
            </div>
        </div>
        <div class="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-5 sm:px-6  shadow dark:shadow-2xl sm:rounded">
            <div class="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                ...
                <div class="ml-4 mt-2 flex-shrink-0">
                    <router-link :to="{ name: 'agreements.create' }"
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <TransitionGroup name="list" tag="table" class="min-w-full divide-y divide-gray-300 dark:dive-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr v-for="fee in agreements"
                                    :key="fee.id" class="transition-all">
                                    ...
                                    <td
                                        ...
                                        <router-link :to="{ name: 'agreements.edit', params: { id: fee.id } }" href="#" class="text-indigo-600 hover:text-indigo-900 mx-5">Editar<span
                                                class="sr-only">, {{ fee.id }}</span></router-link>
                                        <a href="#" @click="deleteAgreement(fee.id)"
...
const { agreements, getAgreements, destroyAgreement } = useAgreements();
