    ...
    <div class="">
        <form @submit.prevent="saveOperator()"
            ...
            <div class="px-4 py-6 sm:p-8">
                <h2 class="my-8 text-3xl font-extrabold dark:text-white">Operador</h2>
...
const { errors, updateOperator, operator, getOperator } = useOperators();

const saveOperator = async () => {
    updateOperator(props.id)
}
...
onMounted(getOperator(props.id))
