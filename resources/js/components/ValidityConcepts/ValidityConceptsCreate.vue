    ...
    <div class="">
        <form @submit.prevent="saveValidityConcept()"
            ...
            <div class="px-4 py-6 sm:p-8">
                <h2 class="my-8 text-3xl font-extrabold dark:text-white">Nuevo Concepto de Vigencia</h2>
...
const { errors, storeValidityConcept } = useValidityConcepts();
...
const saveValidityConcept = async () => {
    await storeValidityConcept({ ...form });
}
